...
QMAKE    = /usr/bin/qmake
terrainGen.xcodeproj/project.pbxproj: terrainGen.pro .qmake.cache /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o terrainGen.xcodeproj/project.pbxproj terrainGen.pro
